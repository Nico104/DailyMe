...
CustomColors getCustomColors(BuildContext context) {
  return Theme.of(context).extension<CustomColors>() ??
      CustomColors(
        accent: Colors.blue.withValues(alpha: 0.0),
        accentLessContrast: Colors.blueAccent.withValues(alpha: 0.0),
        accentHighContrast: Colors.green.withValues(alpha: 0.0),
        lightBorder: Colors.grey.withValues(alpha: 0.0),
        hardBorder: Colors.black.withValues(alpha: 0.0),
        surface: Colors.white.withValues(alpha: 0.0),
        lightShadow: Colors.black12.withValues(alpha: 0.0),
        secondaryAccent: Colors.green.withValues(alpha: 0.0),
        error: Colors.red.withValues(alpha: 0.0),
      );
}
