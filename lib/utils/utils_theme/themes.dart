...
final ThemeData constLightTheme = ThemeData(
  ...
  textSelectionTheme: TextSelectionThemeData(
    selectionHandleColor: Colors.black87, // <-- changes the handle color
    selectionColor: Colors.black12.withValues(alpha: 0.2), // selection highlight
    cursorColor: Colors.black87, // cursor itself
